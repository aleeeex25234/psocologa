                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-[#749B8F]/5 p-8 rounded-2xl border-l-4 border-[#749B8F] space-y-4">
                            <div className="flex items-center gap-3 text-[#749B8F]">
                                <RefreshCw size={24} />
                                <h2 className="font-bold text-xl text-gray-800">Sinergia Teórica</h2>
                            </div>
                        ...
                        <div className="bg-[#749B8F]/5 p-8 rounded-2xl border-l-4 border-[#749B8F] space-y-4">
                            <div className="flex items-center gap-3 text-[#749B8F]">
                                <GitBranch size={24} />
                                <h2 className="font-bold text-xl text-gray-800">Perspectiva Evolutiva</h2>
                            </div>
                            <p className="text-sm text-justify">
                        ...
                        <div className="bg-[#749B8F]/5 p-8 rounded-2xl border-l-4 border-[#749B8F] space-y-4">
                            <div className="flex items-center gap-3 text-[#749B8F]">
                                ...
                                <h2 className="font-bold text-xl text-gray-800">Compromiso Ético</h2>
                            </div>
                            <p className="text-sm text-justify">
                        ...
                        <div className="bg-[#749B8F]/5 p-8 rounded-2xl border-l-4 border-[#749B8F] space-y-4">
                            <div className="flex items-center gap-3 text-[#749B8F]">
                                <ShieldCheck size={24} />
                                <h2 className="font-bold text-xl text-gray-800">Bienestar Multidimensional</h2>
                            </div>
                            <p className="text-sm text-justify">
