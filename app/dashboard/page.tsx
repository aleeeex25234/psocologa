...
export default async function Dashboard(props: {
  ...
  return (
    <main suppressHydrationWarning className="min-h-screen bg-[#A0E8D0] p-4 sm:p-8 font-sans">
      <header className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center max-w-7xl mx-auto gap-4">
        <div>
          <h1 className="font-serif text-3xl sm:text-4xl text-slate-800 mb-2 font-bold">Panel de Citas</h1>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex items-center justify-between">
            <div>
              <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Citas</div>
              <div className="text-4xl font-serif text-slate-800 font-bold">{citasCount}</div>
            </div>
            <div className="h-12 w-12 bg-turquoise-50 rounded-full flex items-center justify-center text-turquoise-600">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex items-center justify-between">
            <div>
              <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Ganancias (Día)</div>
              <div className="text-4xl font-serif text-slate-800 font-bold">{earningsToday}€</div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex items-center justify-between">
            <div>
              <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Ganancias (Mes)</div>
              <div className="text-4xl font-serif text-slate-800 font-bold">{earningsMonth}€</div>
              <div className="text-xs text-gray-400 mt-1">Acumulado {format(new Date(), 'MMMM', { locale: es })}</div>
            </div>
        ...
        <div className="space-y-4">
          <h2 className="font-serif text-2xl text-slate-800 font-bold ml-1">Agenda Detallada</h2>
